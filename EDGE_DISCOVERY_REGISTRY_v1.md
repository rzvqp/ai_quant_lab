...
- **Status**: DISCOVERY_IN_PROGRESS (Stage 2, full profile complete 2026-07-22 —
  ...
  Final Verdict — below the ~5-6yr horizon; V0 NOT SUPPORTED — inverted-FVG reaction is a coin flip
  (~50-53%) on both timeframes, every gap-size filter, session, volatility regime, trend context, day
  of week, and year; a large, real directional effect WAS found for the natural un-inverted-FVG
  control, mirroring E010's own unflipped-OB finding — flagged as a possible future, separate edge;
  full detail `edge_research/E012_inverted_fvg.md`)
- **Version**: V0 (frozen; no V1 candidate offered — see the research log's own explanation)
