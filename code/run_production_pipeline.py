...
# ── GARD 1 ────────────────────────────────────────────────────────────────────────────────────────
GATED_BY_CTO: bool = True      # COBORÂT la loc după măsurătoarea MAE/MFE (Sarcina 1). Se ridică EXCLUSIV per
#                               rulare, prin decizie CTO. GARD 2 (segmentul sigilat) neatins mereu.
