...
- **M14-1 OB-rejection (m14_ob.py, ratified Mod.5 order_flow):** INFO: OB polarity does NOT predict direction — demand & supply OBs both resolve in the ERA-TREND (demand-OB->LONG asym DISC -0.75/CONF +0.75/OOS +0.15; supply mirror). BOUNDED-NEGATIVE (era-split, R20). Remaining M14 branches: OB-mitigation, demand-zone-reentry. **UNIVERSAL FINDING across M13/M14/M08/M09: every directional-polarity primitive -> era-trend, not mechanism-direction (R20). The only edge remains S5 (structural session breakout, direction self-supplied).**
