...
- **Status:** `INFO_CROSS_STABLE_PENDING_CHARACTERIZATION`. NEXT: §8 full outcome distribution (MFE/MAE/adverse-first/time-to); §14-15 structural-stop strategy (stop = recent M15 swing high / ATR from observed MAE, NO forced RR, M15 does not own stop), net STRESS expectancy cross-era (DEV/b0/b1), event-deduped; §16 frequency; §17 independence vs S5/COMP-CONT-L (SHORT in DOWN H4 vs COMP-CONT-L LONG in QUIET->UP -> likely non-redundant). If net-positive+non-redundant -> Stage-C freeze + notify.
