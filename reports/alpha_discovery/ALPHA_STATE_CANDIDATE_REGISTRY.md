...
- **ST-M15-HIGHVOL-SHORT-DOWNPARENT** (LEAD) — high-vol M15 short CONDITIONED on H1 DOWN parent regime: DEV avgR +0.102 (WR .48, N=239, struct 1.5ATR rr1.5; best10 -0.048). Economically high-vol confirms downtrend. Status **LEAD_CROSS_ERA_TBD** — decisive same-regime cross-era check (DOWN-parent high-vol-short on b0/b1) pending; H1 DOWN shorts were era-unstable so guarded.
