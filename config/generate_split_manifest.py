...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz_frequency_constraint_touch_funnel_v2_7_17": {
            ...
            "full_resolution_document": "ai_quant_lab statistician/STATISTICIAN_OBDZ_FREQUENCY_CONSTRAINT_AND_TOUCH_FUNNEL_v1.0.md",
        },
