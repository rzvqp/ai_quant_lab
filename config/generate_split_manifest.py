...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "operational_mode_entry_queue_status_v2_7_32": {
            "status": "STANDING PROCEDURE CONFIRMED -- Statistician no longer waits for a fresh mandate before defining the seven-part statistical protocol for any candidate reaching SURVIVED_RED_TEAM_A. Zero candidates currently qualify; no protocol defined this mandate.",
