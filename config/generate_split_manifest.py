    ...
    manifest: dict[str, Any] = {
        ...
        "zone_survey_arm_a_trigger_lv_bpr_v1_authorization_v2_7_27": {
            ...
            "part_3_V1_authorized_V2_V3_correctly_abandoned": {
                ...
                "V1_authorized_construction": "entry_idx=q+1, sl_price=min/max of the two relevant wicks, R=|entry-sl| (floor R>=0.60 already correctly applied in the count), TP1=entry+2R, TP2=entry+3R, horizon=min(entry_idx+20,EOD), standard WP-5' test on net_R. Population=300 aggregate survivors (181 demand/119 supply), per-regime 129/90/81 -- polarity stratification mandatory in reporting.",
