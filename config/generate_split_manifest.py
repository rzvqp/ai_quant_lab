    ...
    manifest: dict[str, Any] = {
        ...
        "next_hypothesis_atr_partial_exit_v2_7_8": {
            ...
            "five_criteria_status": {
                ...
                "horizon_as_bars": "VARIABLE (see horizon_variable_not_fixed), UPPER-BOUNDED AT 20 -- resolved (Mandate 3.23): min(entry+20,EOD) never exceeds 20 bars, so the true dependency window is bounded by the SAME H=20 already covered by block_bootstrap@v1's L>=28 validation (Mandate 3.20) -- the variable horizon does not break oracle coverage. Still reported as a realized-horizon distribution, per the original deviation disclosure.",
                "population": "CONFIRMED NON-EMPTY (Mandate 3.23) -- 89.75% of discovery bars clear the ATR floor (see eligibility_filter.CRITICAL_FLAG_hypothesis_threatening_RETRACTED); exact eligible-trade count after the compound DemandZone/OB entry condition remains to be measured at execution, not assumed.",
