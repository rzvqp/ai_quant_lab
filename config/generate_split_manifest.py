...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "next_hypothesis_atr_partial_exit_v2_7_8": {
            "status": "FORMALLY PRE-REGISTERED (Mandate 3.24) -- proposed namespace OBDZ-001 (Order Block x Demand Zone), checked for collision against E0xx/S0xx/LM-00x, pending CEO ratification. AWAITING_VALIDATION_ENGINE_CODE -- first permitted execution is the population-count script (see population_estimate_v2_7_10), not the full statistical test.",
