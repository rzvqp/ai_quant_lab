...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz002_confirmation_eliminated_final_spec_v2_7_23": {
            "status": "FINAL SPECIFICATION -- confirmation gate REMOVED from OBDZ-002; run authorized (single task, per explicit mandate instruction)",
