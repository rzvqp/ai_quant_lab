...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz_three_arm_grid_reading_v2_7_16": {
            ...
            "full_resolution_document": "ai_quant_lab statistician/STATISTICIAN_OBDZ_THREE_ARM_GRID_READING_v1.0.md",
        },
