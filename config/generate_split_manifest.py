...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz_sltp_ratio_diagnostic_spec_v2_7_13": {
            "status": "SPECIFICATION ONLY (Mandate 3.27) -- nothing executed, VE implements after publication",
