...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz001_final_verdict_v2_7_12": {
            ...
            "full_resolution_document": "ai_quant_lab statistician/STATISTICIAN_OBDZ001_FINAL_VERDICT_v1.0.md",
        },
