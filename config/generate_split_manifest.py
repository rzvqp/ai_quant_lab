...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz_mae_mfe_window_pullback_control_correction_v2_7_15": {
            "status": "SPECIFICATION (Mandate 3.29) -- corrects two of Statistician's own design errors in the prior measurement; VE executed exactly as specified, errors are not execution errors",
            ...
            "full_resolution_document": "ai_quant_lab statistician/STATISTICIAN_OBDZ_MAE_MFE_WINDOW_AND_PULLBACK_CONTROL_CORRECTION_v1.0.md",
        },
