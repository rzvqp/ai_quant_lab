...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz_mae_mfe_control_confirmation_v2_7_14": {
            "status": "SPECIFICATION (Mandate 3.28) -- corrects the prior diagnostic's mechanical verdict, specifies the next measurement, defers OBDZ-002's numeric parameters",
            ...
            "full_resolution_document": "ai_quant_lab statistician/STATISTICIAN_OBDZ_MAE_MFE_CONTROL_AND_CONFIRMATION_SPEC_v1.0.md",
        },
