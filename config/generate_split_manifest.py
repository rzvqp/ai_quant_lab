...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "next_hypothesis_atr_partial_exit_v2_7_8": {
            "status": "AUTHORIZED FOR IMPLEMENTATION (Mandate 3.25) -- namespace OBDZ-001 (Order Block x Demand Zone), pending CEO ratification of the name only (spec itself is authorized). Population count cleared INSUFFICIENT_N in all 3 regimes (see composite_hypothesis_formalization_v2_7_10.population_count_results_v2_7_11). VE authorized to implement the full state machine and run the WP-5' block_bootstrap test, discovery data only, holdout untouched.",
