...
def build_manifest() -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        ...
        "obdz002_confirmation_window_spec_v2_7_22": {
            "status": "SPECIFICATION (single task, per explicit mandate instruction) -- fixes the confirmation window, the abandon rule, and the sizing-ATR bar; authorizes exactly one next step (the post-confirmation population count)",
