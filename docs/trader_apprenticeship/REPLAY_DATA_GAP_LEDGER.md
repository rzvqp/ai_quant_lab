...
### GAP-164 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (75min)
...
### GAP-166 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
...
### GAP-168 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-10-27T20:59:59Z (last close 1907.78, Q4 bar 1740, Tuesday -- inside TRADE #8's open hold)
-> 2020-10-27T22:00:00Z (first open 1907.78, Q4 bar 1741)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
...
### GAP-173 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-03T21:59:59Z (last close 1909.81, Q4 bar 2200, Tuesday -- inside TRADE #11's open
...
### GAP-175 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-05T21:59:59Z (last close 1949.632, Q4 bar 2384, Thursday -- inside TRADE #13's open
hold) -> 2020-11-05T23:00:00Z (first open 1949.632, Q4 bar 2385)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-176 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard weekend (~49h)
SPAN: 2020-11-06T21:59:59Z (last close 1951.193, Q4 bar 2476, Friday) -> 2020-11-08T23:00:00Z (first
open 1951.193, Q4 bar 2477, Sunday)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified WEEKEND
-- did not require a reasoning stop.

### GAP-177 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-09T21:59:59Z (last close 1861.914, Q4 bar 2568, Monday -- inside Q4-P007-024's still-
...
### GAP-180 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard weekend (~49h)
SPAN: 2020-11-13T22:00:00Z (last close 1889.565, Q4 bar 2936, Friday -- inside TRADE #17's open
hold) -> 2020-11-15T23:00:00Z (first open 1889.565, Q4 bar 2937, Sunday)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified WEEKEND
-- did not require a reasoning stop.

### GAP-182 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-16T22:00:00Z (last close 1888.944, Q4 bar 3028, Monday -- inside TRADE #18's open
hold) -> 2020-11-16T23:00:00Z (first open 1888.944, Q4 bar 3029)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-183 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-18T22:00:00Z (last close 1872.464, Q4 bar 3212, Wednesday -- inside TRADE #21's open
hold) -> 2020-11-18T23:00:00Z (first open 1872.464, Q4 bar 3213)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-184 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-19T22:00:00Z (last close 1866.12, Q4 bar 3304, Thursday -- inside Q4-P007-039's basing
period) -> 2020-11-19T23:00:00Z (first open 1866.12, Q4 bar 3305)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-185 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard weekend (~49h)
SPAN: 2020-11-20T22:00:00Z (last close 1870.987, Q4 bar 3396, Friday -- inside TRADE #22's open hold)
-> 2020-11-22T23:00:00Z (first open 1870.987, Q4 bar 3397, Sunday)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified WEEKEND
-- did not require a reasoning stop.

### GAP-186 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-23T22:00:00Z (last close 1837.828, Q4 bar 3488, Monday -- inside Q4-P007-040's decline)
-> 2020-11-23T23:00:00Z (first open 1837.828, Q4 bar 3489)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-187 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-24T22:00:00Z (last close 1807.459, Q4 bar 3580, Tuesday -- inside Q4-P007-040's basing
period) -> 2020-11-24T23:00:00Z (first open 1807.459, Q4 bar 3581)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-188 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-25T22:00:00Z (last close 1807.846, Q4 bar 3672, Wednesday -- inside Q4-P007-040's
...
### GAP-191 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-11-30T22:00:00Z (last close 1776.881, Q4 bar 3919, Monday -- inside TRADE #23's open hold)
-> 2020-11-30T23:00:00Z (first open 1776.881, Q4 bar 3920)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-192 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-01T22:00:00Z (last close 1815.137, Q4 bar 4011, Tuesday -- inside TRADE #24's open
hold) -> 2020-12-01T23:00:00Z (first open 1815.137, Q4 bar 4012)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-193 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-02T22:00:00Z (last close 1830.705, Q4 bar 4103, Wednesday -- inside TRADE #25's open
hold) -> 2020-12-02T23:00:00Z (first open 1830.705, Q4 bar 4104)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-194 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-03T22:00:00Z (last close 1840.936, Q4 bar 4195, Thursday) -> 2020-12-03T23:00:00Z
...
### GAP-199 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-09T22:00:00Z (last close 1840.086, Q4 bar 4565, Wednesday -- inside Q4-P007-052's
...
### GAP-201 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard weekend (~49h)
SPAN: 2020-12-11T22:00:00Z (last close 1839.303, Q4 bar 4749, Friday -- inside TRADE #30's open hold)
-> 2020-12-13T23:00:00Z (first open 1839.303, Q4 bar 4750, Sunday)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified WEEKEND
-- did not require a reasoning stop.

### GAP-202 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-14T22:00:00Z (last close 1827.059, Q4 bar 4841, Monday -- inside Q4-P007-057's ongoing
episode) -> 2020-12-14T23:00:00Z (first open 1827.059, Q4 bar 4842)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-203 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-15T22:00:00Z (last close 1853.45, Q4 bar 4933, Tuesday) -> 2020-12-15T23:00:00Z (first
open 1853.45, Q4 bar 4934)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-204 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-16T22:00:00Z (last close 1864.552, Q4 bar 5025, Wednesday) -> 2020-12-16T23:00:00Z
(first open 1864.552, Q4 bar 5026)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-205 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-17T22:00:00Z (last close 1885.546, Q4 bar 5117, Thursday -- inside TRADE #33's open
hold) -> 2020-12-17T23:00:00Z (first open 1885.546, Q4 bar 5118)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-206 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard weekend (~49h)
SPAN: 2020-12-18T22:00:00Z (last close 1881.479, Q4 bar 5209, Friday) -> 2020-12-20T23:00:00Z (first
open 1881.479, Q4 bar 5210, Sunday)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified WEEKEND
-- did not require a reasoning stop.

### GAP-207 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-21T22:00:00Z (last close 1876.848, Q4 bar 5301, Monday -- inside Q4-P007-062's ongoing
episode) -> 2020-12-21T23:00:00Z (first open 1876.848, Q4 bar 5302)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-208 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-22T22:00:00Z (last close 1860.254, Q4 bar 5393, Tuesday -- inside Q4-P007-065's ongoing
episode) -> 2020-12-22T23:00:00Z (first open 1860.254, Q4 bar 5394)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-209 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-23T22:00:00Z (last close 1873.37, Q4 bar 5485, Wednesday -- inside TRADE #35's ongoing
hold) -> 2020-12-23T23:00:00Z (first open 1873.37, Q4 bar 5486)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.

### GAP-211 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-28T22:00:00Z (last close 1873.694, Q4 bar 5656, Monday -- inside Q4-P007-071's ongoing
episode) -> 2020-12-28T23:00:00Z (first open 1873.694, Q4 bar 5657)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.
...
### GAP-213 [Q4 2020, CSV_CAUSAL_REPLAY_ADAPTER_V1 transport]
TYPE: Standard daily rollover (60min)
SPAN: 2020-12-30T22:00:00Z (last close 1894.508, Q4 bar 5840, Wednesday -- inside TRADE #39's
ongoing hold) -> 2020-12-30T23:00:00Z (first open 1894.508, Q4 bar 5841)
VERIFICATION: exact last-close == first-open match (zero-price-gap). Mechanically classified
MAINTENANCE -- did not require a reasoning stop.
