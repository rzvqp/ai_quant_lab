...
|---|---|---|---|---|---|---|---|
| **CAND-0001** | PDH-PDL | institutional_reference_levels (MK-04) | `POLICY_PDH_PDL_v1.md` | DEFINED | UNSPECIFIED | PARTIALLY DEFINED | **STATISTICIAN_PROTOCOL_SPECIFIED** (STAT-BATCH-A-0001; W-conf→matched-null reused from OBDZ, W-sel disclosed not corrected, W-ovl→mandatory diagnostic vs CAND-0007, W-e010→AMBIGUOUS, routed back to Red Team for clarification) → Validation Engine (blocked on Part B) |
| **CAND-0002** | COMPRESSION-EXPANSION-BREAKOUT | volatility_state_transition (market_state) | `POLICY_COMPRESSION_EXPANSION_v1.md` | DEFINED (with disclosed compression-anchoring risk) | UNSPECIFIED | PARTIALLY DEFINED | **STATISTICIAN_PROTOCOL_SPECIFIED** (STAT-BATCH-A-0001; compression-anchoring risk carried forward unchanged as a standing limitation) → Validation Engine (blocked on Part B) |
| **CAND-0003** | FVG-CE50-REACTION | imbalance_reaction (MK-03) | `POLICY_FVG_REACTION_v1.md` | DEFINED | UNSPECIFIED | PARTIALLY DEFINED | **STATISTICIAN_PROTOCOL_SPECIFIED** (STAT-BATCH-A-0001; standard protocol, no additional controls) → Validation Engine (blocked on Part B) |
...
| **CAND-0007** | LEVEL-FVG-CONFLUENCE | multi_structure_confluence (MK-04×MK-03 via Mod.7) | `POLICY_LEVEL_FVG_CONFLUENCE_v1.md` | DEFINED (3-primitive interaction) | UNSPECIFIED | PARTIALLY DEFINED | **STATISTICIAN_PROTOCOL_SPECIFIED** (STAT-BATCH-A-0001; H0=incremental value vs better of CAND-0001/CAND-0003 on identical bars, k=0 primary/{1,2} sensitivity fixed pre-results) → Validation Engine (blocked on Part B) |
