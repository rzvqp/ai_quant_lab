...
> ⚠️ **BINDING CONSTRAINT (CEO 2026-07-24).** A verdict is a **RISK VERDICT — an assessment of the candidate's vulnerabilities — not a laboratory decision.** Red Team does **not** promote, demote, finally accept or finally reject. **Red Team decides risk; the Statistician decides testable / insufficiently supported / statistically robust / statistically rejected; the CEO alone decides Knowledge-Base promotion, archiving, closure and official status.** Read every verdict below in that light: 🟢 does not promote, 🔴 does **not** mean "rejected" — it means *Red Team does not recommend continuation in the current form*, after which the CEO may still choose revision, Addendum, Statistician or archiving. Full model: [RISK_VERDICTS](RISK_VERDICTS.md). **"REJECT" is retired from Red Team's vocabulary.**
