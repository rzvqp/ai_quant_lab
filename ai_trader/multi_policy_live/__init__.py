...
CAND-0007 + CAND-0019 (CAND-0009 built but inactive) -- independent recognition -> risk -> order paths
built and CEO-authorized live 2026-08-04, predating the canonical N1-N6/`ve_brain`/`new_brain_live`
chain and the new generic Strategy Catalog/Router/EV/Risk architecture built under this mandate.
...
CAND-0007 and CAND-0019 have no automatic grandfathering into the new Strategy Catalog. They may enter
the new architecture only through the future validated-strategy onboarding process, after Alpha ->
Statistician -> Red Team -> CEO ratification of a genuinely validated strategy -- never by virtue of
this package's prior live history."""
